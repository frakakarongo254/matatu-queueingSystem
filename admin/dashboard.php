    ...
    <div class="container-fluid ">
	 ...
	 <div class="col-md-12 col-md-offset-3">
      ...
      <div class="row" style="text-align:center;">
        <div class="col-xl-5 col-sm-6 mb-3">
          <div class="card text-white bg-primary o-hidden h-100" style="text-align:center">
            <div class="card-body">
			 ...
			 <?php 
			 include("config2.php");
			 $coderesult= mysqli_query($conn,"select * from `matatu` where `status` ='Active' ");
			 $row=mysqli_num_rows ( $coderesult );
              echo "<b>".$row.  "</b><br>";
			  ?>  <b>Matatus</b>
			  </div>
            </div>
            <a class="card-footer text-white clearfix small z-1" href="matatu.php">
        ...
        <div class="col-xl-5 col-sm-6 mb-3">
          <div class="card text-white bg-warning o-hidden h-100">
            <div class="card-body">
              ...
              <div class="mr-5">
			  <?php 
			 $coderesult= mysqli_query($conn,"select * from `user` where `status` ='Active' and `level` ='Conductor' ");
			 $row=mysqli_num_rows ( $coderesult );
              echo "<b>".$row.  "</b></br>";
			  ?>  <b>Registered Conductor</b></div>
            </div>
		...
		<div class="row">
        <div class="col-xl-5 col-sm-6 mb-3  col-md-offset-5">
          <div class="card text-white bg-success o-hidden h-100">
            <div class="card-body">
              ...
              <div class="mr-5">
			  <?php 
			 $coderesult= mysqli_query($conn,"select * from `sacco` where `status` ='Active' ");
			 $row=mysqli_num_rows ( $coderesult );
              echo "<b>".$row.  "</b></br>";
			  ?>   <b>SACCOS Available </b>
			  </div>
            </div>
            <a class="card-footer text-white clearfix small z-1" href="sacco.php">
              <span class="float-left">View Details</span>
              <span class="float-right">
                <i class="fa fa-angle-right"></i>
              </span>
        ...
        <div class="col-xl-5 col-sm-6 mb-3">
          <div class="card text-white bg-danger o-hidden h-100">
			...
			$coderesult= mysqli_query($conn,"select * from `trips` where `id` !='Active' ");
			 $row=mysqli_num_rows ( $coderesult );
              echo "<b>".$row.  "</b></br>";
			 ?>
			 <b>Registered Routes</b>
			  </div>
            </div>
